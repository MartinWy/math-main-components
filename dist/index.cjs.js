...
function Accordeon({ title, children }) {
    ...
    return (React__default["default"].createElement("div", { className: [styles$u.container, isActive ? styles$u.active : styles$u.not_active].join(" ") },
        React__default["default"].createElement("div", { className: styles$u.head, onClick: () => setActive(!isActive) },
            React__default["default"].createElement(SvgIcon, { iconName: "expand_more" }),
            React__default["default"].createElement("h3", null, title)),
        React__default["default"].createElement("div", { className: styles$u.content }, children)));
}
...
function AuthButton({ text, type = "submit", theme = "primary", iconName = "arrow_forward", isVisible = true, onClick }) {
    return (React__default["default"].createElement("div", { className: [styles$t.container, isVisible ? styles$t.visible : styles$t.hidden, ["arrow_forward"].includes(iconName) ? styles$t.rotate : null].join(" ") },
        React__default["default"].createElement("button", { type: type, className: `${styles$t.button} ${styles$t[theme]}`, onClick: onClick },
            text,
...
function ForwardButton({ onClick }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$l.container },
        React__default["default"].createElement("button", { onClick: onClickButton, className: styles$l.button },
...
function InputArea({ title, name, placeholder = "", defaultValue = "", autoFocus = false, width = "100%", height = "100px", available = true, onInput }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$k.container, style: { width } },
            React__default["default"].createElement("textarea", { className: `${styles$k.input} ${title != undefined ? styles$k.with_title : styles$k.without_title} ${value.length > 0 || defaultValue.length > 0 ? styles$k.valid : styles$k.not_valid} ${available ? styles$k.available : styles$k.not_available}`, name: name, placeholder: placeholder, ref: inputElement, defaultValue: defaultValue, style: { minHeight: height, maxHeight: height }, onInput: (event) => {
...
function InputMail({ placeholder = "E-Mail-Adresse", title = "E-Mail-Adresse", name = "email", width = "100%", available = true }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$j.container, style: { width: width } },
            React__default["default"].createElement("input", { className: `${styles$j.input} ${title != undefined ? styles$j.with_title : styles$j.without_title} ${value.length > 0 ? styles$j.valid : styles$j.not_valid} ${available ? styles$j.available : styles$j.not_available}`, name: name, placeholder: placeholder, type: "email", onInput: (event) => setValue(event.target.value) }),
...
function InputNames({ width = "100%", placeholder = { firstName: "", lastName: "" }, title = { firstName: "Vorname", lastName: "Nachname" }, defaultValue = { firstName: "", lastName: "" }, onInput = (name, event) => { }, onInputFirstName = (event) => { }, onInputLastName = (event) => { }, }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$i.container, style: { width: width } },
        React__default["default"].createElement("div", { className: styles$i.form },
            React__default["default"].createElement("input", { className: `${styles$i.input} ${title.firstName != undefined ? styles$i.with_title : styles$i.without_title} ${value1.length > 0 ? styles$i.valid : styles$i.not_valid}`, name: "firstName", type: "name", style: { width: width != "100%" ? "100px" : width }, placeholder: placeholder.firstName, defaultValue: defaultValue.firstName, onInput: onInput1 }),
            React__default["default"].createElement("label", { htmlFor: "text", className: styles$i.label },
                React__default["default"].createElement("span", { className: styles$i.label_text }, title.firstName))),
        React__default["default"].createElement("div", { className: styles$i.form },
            React__default["default"].createElement("input", { className: `${styles$i.input} ${title.lastName != undefined ? styles$i.with_title : styles$i.without_title} ${value2.length > 0 ? styles$i.valid : styles$i.not_valid}`, name: "lastName", type: "name", style: { width: width != "100%" ? "100px" : width }, placeholder: placeholder.lastName, defaultValue: defaultValue.lastName, onInput: onInput2 }),
            React__default["default"].createElement("label", { htmlFor: "text", className: styles$i.label },
                React__default["default"].createElement("span", { className: styles$i.label_text }, title.lastName)))));
}
...
function InputNumber({ title, name, placeholder = "", defaultValue = "", autoFocus = false, type = "number", width = "100%", available = true, onInput = (event) => { } }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$h.container, style: { width } },
...
function InputPassword({ placeholder = "", title = "Passwort", name, isVisible = true, width = "100%", minLength = 8, autoComplete, forgotLink = false }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: `${styles$g.container} ${isVisible ? styles$g.visible : styles$g.hidden}`, style: { width: width } },
            React__default["default"].createElement("div", { className: styles$g.form },
                React__default["default"].createElement("input", { className: `${styles$g.input} ${title != undefined ? styles$g.with_title : styles$g.without_title} ${value.length > 0 ? styles$g.valid : styles$g.not_valid}`, name: name, minLength: minLength, autoComplete: autoComplete, placeholder: placeholder, type: hidePassword ? "password" : "text", onInput: (event) => setValue(event.target.value) }),
                ...
                React__default["default"].createElement("button", { title: hidePassword ? "Passwort anzeigen" : "Passwort verstecken", className: styles$g.hideButton, onClick: () => setHidePassword(!hidePassword), type: "button" },
                    React__default["default"].createElement(SvgIcon, { iconName: hidePassword ? "visibility" : "visibility_off" }))),
            forgotLink &&
                React__default["default"].createElement("div", { className: styles$g.forgot_container }, forgotLink))));
}
...
function InputPin({ name, length, onFinished = () => { } }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$f.container },
        ...
        React__default["default"].createElement("div", { className: styles$f.input_wrapper }, [...Array(length)].map((value, i) => {
            if (i == 0) {
                return React__default["default"].createElement("input", { key: i, pattern: "[0-9]", value: state[i] ? state[i] : "", ref: fieldRefs.current[i], className: styles$f.input, type: "text", onKeyUp: (event) => onKeyUp(event, i), onInput: (event) => onChange(event, i) });
            }
            return React__default["default"].createElement("input", { key: i, pattern: "[0-9]", value: state[i] ? state[i] : "", ref: fieldRefs.current[i], className: styles$f.input, type: "text", onKeyUp: (event) => onKeyUp(event, i), onInput: (event) => onChange(event, i) });
        })),
...
function InputText({ title, name, placeholder = "", defaultValue = "", autoFocus = false, type = "text", width = "100%", marginBottom, available = true, onInput = (event) => { } }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$e.container, style: { width, marginBottom } },
            React__default["default"].createElement("input", { className: `${styles$e.input} ${title != undefined ? styles$e.with_title : styles$e.without_title} ${value.length > 0 || defaultValue.length > 0 ? styles$e.valid : styles$e.not_valid} ${available ? styles$e.available : styles$e.not_available}`, name: name, type: type, placeholder: placeholder, ref: inputElement, defaultValue: defaultValue, onInput: (event) => {
                    setValue(event.target.value);
                    if (onInput)
                        onInput(event);
                } }),
            React__default["default"].createElement("label", { htmlFor: "text", className: styles$e.label },
                React__default["default"].createElement("span", { className: styles$e.label_text }, title)))));
}
...
function OptionField({ headline, description, iconName }) {
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$d.box },
            React__default["default"].createElement("div", { className: styles$d.left_side }, iconName && React__default["default"].createElement(SvgIcon, { iconName: iconName })),
            React__default["default"].createElement("div", { className: styles$d.right_side },
...
function OptionFieldHorizontal({ title, iconName, onClick, preselected = false }) {
    ...
    return (React__default["default"].createElement("div", { className: [styles$c.container, preselected ? styles$c.preselected : styles$c.not_preselected].join(" "), onClick: onClickDiv },
    ...
    return (React__default["default"].createElement("div", { className: styles$3.container },
        ...
        React__default["default"].createElement("ul", { className: `${styles$3.item_list} ${items.length > 0 ? styles$3.has_children : styles$3.no_children}` }, items.map((item, index) => React__default["default"].createElement("li", { key: index, className: styles$3.item },
            ...
            actions.length > 0 && actions.map((action, idx) => React__default["default"].createElement("div", { key: idx, className: [
                    styles$3.action,
                    action.type == exports.TableActionType.red && styles$3.red,
                    action.type == exports.TableActionType.default && styles$3.default,
