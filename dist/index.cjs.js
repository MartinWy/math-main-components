...
function CardButton({ title, iconName, onClick, }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$t.card, onClick: onClickCard },
...
function Dialog({ data, text, onClose, onSubmit, children }) {
    ...
    return (React__default["default"].createElement("div", { id: "dialog-backdrop", className: `${styles$p.container} ${data?.isActive ? styles$p.active : styles$p.disabled}`, onClick: onClick },
        React__default["default"].createElement("div", { className: styles$p.dialog_window },
            children,
            text && React__default["default"].createElement("h1", null, text),
            React__default["default"].createElement("button", { className: styles$p.cancel_button, id: "cancel-button", onClick: onClick }, "Abbrechen"),
            React__default["default"].createElement("button", { className: styles$p.submit_button, id: "submit-button", onClick: (event) => onSubmit && onSubmit(event, data?.data) }, "Best\u00E4tigen"))));
}
...
function FormButton({ text, style = {}, iconName = "", type = "submit", background = "#0075FF", onClick = () => { } }) {
    return (React__default["default"].createElement("div", { className: styles$o.container, style: style },
...
function ForwardButton({ onClick }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$m.container },
        React__default["default"].createElement("button", { onClick: onClickButton, className: styles$m.button },
...
function InputArea({ title, name, placeholder = "", defaultValue = "", autoFocus = false, width = "100%", height = "100px", available = true, onInput }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$l.container, style: { width } },
            React__default["default"].createElement("textarea", { className: `${styles$l.input} ${title != undefined ? styles$l.with_title : styles$l.without_title} ${value.length > 0 || defaultValue.length > 0 ? styles$l.valid : styles$l.not_valid} ${available ? styles$l.available : styles$l.not_available}`, name: name, placeholder: placeholder, ref: inputElement, defaultValue: defaultValue, style: { minHeight: height, maxHeight: height }, onInput: (event) => {
...
function InputMail({ placeholder = "E-Mail-Adresse", title = "E-Mail-Adresse", name = "email", width = "100%", available = true }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$k.container, style: { width: width } },
            React__default["default"].createElement("input", { className: `${styles$k.input} ${title != undefined ? styles$k.with_title : styles$k.without_title} ${value.length > 0 ? styles$k.valid : styles$k.not_valid} ${available ? styles$k.available : styles$k.not_available}`, name: name, placeholder: placeholder, type: "email", onInput: (event) => setValue(event.target.value) }),
...
function InputNames({ width = "100%", placeholder = { firstName: "", lastName: "" }, title = { firstName: "Vorname", lastName: "Nachname" }, defaultValue = { firstName: "", lastName: "" }, onInput = (name, event) => { }, onInputFirstName = (event) => { }, onInputLastName = (event) => { }, }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$j.container, style: { width: width } },
        React__default["default"].createElement("div", { className: styles$j.form },
            React__default["default"].createElement("input", { className: `${styles$j.input} ${title.firstName != undefined ? styles$j.with_title : styles$j.without_title} ${value1.length > 0 ? styles$j.valid : styles$j.not_valid}`, name: "firstName", type: "name", style: { width: width != "100%" ? "100px" : width }, placeholder: placeholder.firstName, defaultValue: defaultValue.firstName, onInput: onInput1 }),
            React__default["default"].createElement("label", { htmlFor: "text", className: styles$j.label },
                React__default["default"].createElement("span", { className: styles$j.label_text }, title.firstName))),
        React__default["default"].createElement("div", { className: styles$j.form },
            React__default["default"].createElement("input", { className: `${styles$j.input} ${title.lastName != undefined ? styles$j.with_title : styles$j.without_title} ${value2.length > 0 ? styles$j.valid : styles$j.not_valid}`, name: "lastName", type: "name", style: { width: width != "100%" ? "100px" : width }, placeholder: placeholder.lastName, defaultValue: defaultValue.lastName, onInput: onInput2 }),
            React__default["default"].createElement("label", { htmlFor: "text", className: styles$j.label },
                React__default["default"].createElement("span", { className: styles$j.label_text }, title.lastName)))));
}
...
function InputNumber({ title, name, placeholder = "", defaultValue = "", autoFocus = false, type = "number", width = "100%", available = true, onInput = (event) => { } }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$i.container, style: { width } },
            React__default["default"].createElement("input", { className: `${styles$i.input} ${title != undefined ? styles$i.with_title : styles$i.without_title} ${value.length > 0 || defaultValue.length > 0 ? styles$i.valid : styles$i.not_valid} ${available ? styles$i.available : styles$i.not_available}`, name: name, type: type, placeholder: placeholder, ref: inputElement, defaultValue: defaultValue, onInput: (event) => {
                    setValue(event.target.value);
                    onInput(event);
                } }),
...
function InputPassword({ placeholder = "", title = "Passwort", name, isVisible = true, width = "100%", minLength = 8, autoComplete, forgotLink = false }) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: `${styles$h.container} ${isVisible ? styles$h.visible : styles$h.hidden}`, style: { width: width } },
            React__default["default"].createElement("div", { className: styles$h.form },
                React__default["default"].createElement("input", { className: `${styles$h.input} ${title != undefined ? styles$h.with_title : styles$h.without_title} ${value.length > 0 ? styles$h.valid : styles$h.not_valid}`, name: name, minLength: minLength, autoComplete: autoComplete, placeholder: placeholder, type: hidePassword ? "password" : "text", onInput: (event) => setValue(event.target.value) }),
                React__default["default"].createElement("label", { htmlFor: "text", className: styles$h.label },
                    React__default["default"].createElement("span", { className: styles$h.label_text }, title)),
                React__default["default"].createElement("button", { title: hidePassword ? "Passwort anzeigen" : "Passwort verstecken", className: styles$h.hideButton, onClick: () => setHidePassword(!hidePassword), type: "button" },
                    React__default["default"].createElement(SvgIcon, { iconName: hidePassword ? "visibility" : "visibility_off" }))),
            forgotLink &&
                React__default["default"].createElement("div", { className: styles$h.forgot_container }, forgotLink))));
}
...
function InputPin({ name, length, onFinished = () => { } }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$g.container },
        ...
        React__default["default"].createElement("div", { className: styles$g.input_wrapper }, [...Array(length)].map((value, i) => {
            if (i == 0) {
                return React__default["default"].createElement("input", { key: i, pattern: "[0-9]", value: state[i] ? state[i] : "", ref: fieldRefs.current[i], className: styles$g.input, type: "text", onKeyUp: (event) => onKeyUp(event, i), onInput: (event) => onChange(event, i) });
            }
            return React__default["default"].createElement("input", { key: i, pattern: "[0-9]", value: state[i] ? state[i] : "", ref: fieldRefs.current[i], className: styles$g.input, type: "text", onKeyUp: (event) => onKeyUp(event, i), onInput: (event) => onChange(event, i) });
        })),
...
function OptionField({ headline, description, iconName }) {
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: styles$e.box },
            React__default["default"].createElement("div", { className: styles$e.left_side }, iconName && React__default["default"].createElement(SvgIcon, { iconName: iconName })),
            React__default["default"].createElement("div", { className: styles$e.right_side },
...
function OptionFieldHorizontal({ title, iconName, onClick, preselected = false }) {
    ...
    return (React__default["default"].createElement("div", { className: [styles$d.container, preselected ? styles$d.preselected : styles$d.not_preselected].join(" "), onClick: onClickDiv },
...
function PrimaryButton({ text, iconName, iconFill = "white", type = "blue", onClick = () => { } }) {
    ...
    return (React__default["default"].createElement("div", { className: styles$c.container },
        React__default["default"].createElement("button", { className: [styles$c.button, styles$c[type], (text && !iconName) ? styles$c.onlyText : "", (!text && iconName) ? styles$c.onlyIcon : ""].join(" "), onClick: onClickButton },
            text,
...
function EmptyCard({ title = "Keine Daten", subtitle = "Es sind keine Daten vorhanden.", iconName = "manage_search", button, onClick }) {
    return (React__default["default"].createElement("div", { className: styles$4.card },
        ...
        button && React__default["default"].createElement(PrimaryButton, { text: button, onClick: onClick })));
}
